                                    ...
                                    <form method="POST" action="{{ route('admin.course.update', $course) }}">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="time" name="duree" class="form-control" value="{{ $course->duree }}">
                                                @error('duree')
                                                    <small class="text-danger">{{$message}}</small>
                                                @enderror
                                                <div class="pt-2 pb-2"></div>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" min="1" name="number_module" class="form-control" value="{{ $course->number_module }}">
                                                @error('number_module')
                                                    <small class="text-danger">{{$message}}</small>
                                                @enderror
                                                <div class="pt-2 pb-2"></div>
