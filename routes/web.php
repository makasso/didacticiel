...
use App\Http\Controllers\Admin\QnAModuleController;
...
Route::prefix('admin')->middleware(['isAdmin', 'auth'])->group(function () {
        ...
        Route::controller(App\Http\Controllers\Login\LoginUserController::class)->group(function () {
            ...
            Route::put('/profile/edit', 'updateProfileUser')->name('admin.profile.edit');
        ...
        Route::controller(App\Http\Controllers\Admin\QnAModuleController::class)->group(function () {
            ...
            Route::post('/qna-ans-module/create', 'store')->name('admin.qnaans-module.create');
...
Route::group(['middleware' => 'guest'], function () {
    ...
    Route::post('/login-student', [AuthStudentController::class, 'LoginStudent'])->name('login-student');
